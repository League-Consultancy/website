    ...
    return (
        <div className="relative w-screen shrink-0 overflow-hidden group" style={{ height: 'calc(100dvh - 80px)' }}>
            ...
            >
                ...
                <div className="flex-1 flex flex-col justify-center max-w-4xl py-4">
                    ...
                    <motion.p variants={itemVariants} className="text-sm sm:text-base md:text-lg text-white/70 leading-relaxed font-light max-w-2xl">
                        {service.shortDescription}
                    </motion.p>
                </div>

                {/* Bottom: Metrics + Tech Tags */}
                    ...
                    <div className="max-w-7xl mx-auto">
                        <FadeIn>
                            <div className="text-center mb-24">
                                <span className="text-brand-gray-400 font-black uppercase tracking-[0.4em] text-[11px] mb-6 block">Our Process</span>
                            ...
                            {[
                                ...
                                <FadeIn key={idx} delay={idx * 0.1} className="h-full">
                                    <div className="p-8 lg:p-10 rounded-[2.5rem] bg-brand-gray-50 dark:bg-[#0A0A0A] border border-brand-gray-100 dark:border-brand-gray-900 shadow-soft hover:shadow-premium transition-all duration-500 hover:-translate-y-2 text-center group h-full flex flex-col justify-center">
                                        ...
                                        <p className="text-xs text-brand-gray-500 dark:text-brand-gray-400 font-light leading-relaxed">{item.desc}</p>
                                    </div>
                                </FadeIn>
                            ))}
                        </div>
                        ...
                        <FadeIn>
                            <div className="p-16 sm:p-24 lg:p-32 bg-brand-black dark:bg-brand-gray-900 rounded-[4rem] text-center text-brand-white shadow-2xl relative overflow-hidden group">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <p className="text-brand-gray-400 text-lg md:text-2xl font-light max-w-2xl mx-auto mb-14 leading-relaxed">
